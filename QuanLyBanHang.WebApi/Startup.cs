    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services
            .AddXafWebApi(Configuration, options => {
                ...
                options.BusinessObject<LoanCard>();
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                ...
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the QuanLyBanHang.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
